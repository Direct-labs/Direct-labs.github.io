...
<!DOCTYPE html>
<!-- saved from url=(0054)http://biologygene.srxsfjy.com/about_01/language_zh-CN -->
<html class=" desktop portrait">
 <head id="Head">
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta id="MetaAuthor" name="AUTHOR" content="Direct-Labs Inc." />
  <meta name="RESOURCE-TYPE" content="DOCUMENT" />
  <meta name="DISTRIBUTION" content="GLOBAL" />
  <meta name="ROBOTS" content="INDEX, FOLLOW" />
  <meta name="REVISIT-AFTER" content="7 DAYS" />
  <meta name="RATING" content="GENERAL" />
  <link id="qhddefaultcontent9676_css" rel="stylesheet" type="text/css" href="/en/templets/default/css/qhdcontent.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_content_css?ver=1_0" rel="stylesheet" type="text/css" href="/en/templets/default/css/content.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_menu_css?ver=1_0" rel="stylesheet" type="text/css" href="/en/templets/default/css/menu.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_jquery_fancybox_1_3_4_css?ver=1_0" rel="stylesheet" type="text/css" href="/en/templets/default/css/jquery.fancybox-1.3.4.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_pgwslideshow_css?ver=1_0" rel="stylesheet" type="text/css" href="/en/templets/default/css/pgwslideshow.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_animate_min_css?ver=1_0" rel="stylesheet" type="text/css" href="/en/templets/default/css/animate.min.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_style_css?ver=1_2" rel="stylesheet" type="text/css" href="/en/templets/default/css/style.css" />
  <link id="_Portals__default_Skins_BiologyGene_Html_css_style_blue_css" rel="stylesheet" type="text/css" href="/en/templets/default/css/style-blue.css" />
<!--   <style>
 html { background-image:url(/Portals/_default/Skins/BiologyGene/Html/images/skin-bg/bg-rep-03.png); }
</style> -->
  <!--[if lt IE 9]>
 <script src="/Portals/_default/Skins/BiologyGene/Html/js/html5.js"></script>
<![endif]-->
  <!--[if IE 6]>
 <script type="text/javascript" src="/Portals/_default/Skins/BiologyGene/Html/js/ie7.js"></script>
 <script type="text/javascript" src="/Portals/_default/Skins/BiologyGene/Html/js/DD_belatedPNG.js"></script>
 <script type="text/javascript">
  DD_belatedPNG.fix('.top img, .footer img, .bottom img, .form-btn, .module-icon-default');
 </script>
<![endif]-->
  <meta content="width=device-width, initial-scale=1.0, user-scalable=no" name="viewport" />
  <title>Beijing Thinkout Sci-Tech Co.,Ltd.</title>
 </head> 
 <!-- 外部样式 --> 
 <body class="font-zh-CN" style="" mycollectionplug="bind"> 
  <form name="Form" method="post" action="http://biologygene.srxsfjy.com/about_01/language_zh-CN" id="Form" enctype="multipart/form-data" style="height:inherit"> 
   <div> 
    <input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" /> 
    <input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" /> 
    <input type="hidden" name="__VIEWSTATE_CACHEKEY" id="__VIEWSTATE_CACHEKEY" value="VS_x0wrozd2mdo2j5nh5h5rnw4u_/about_01/language_zh-CN" /> 
   </div> 
   <script type="text/javascript">
//<![CDATA[
...
//]]>
   ...
   <script src="/en/templets/default/css/a1portalcore.js" type="text/javascript"></script>
   <script src="/en/templets/default/css/a1portal.js"></script>
   <script src="/en/templets/default/css/jquery-1.7.2.min.js"></script>
   <script src="/en/templets/default/css/superfish.js"></script>
   <script src="/en/templets/default/css/jquery.carouFredSel.js"></script>
   <script src="/en/templets/default/css/jquery.touchSwipe.min.js"></script>
   <script src="/en/templets/default/css/jquery.tools.min.js"></script>
   <script src="/en/templets/default/css/jquery.fancybox-1.3.4.pack.js"></script>
      ...
      <div class="drawer-section drawer-section-menu">
       <div class="touch-menu" skinobjectzone="menu_2005">
		 ...
		 <li><a href="javascript:;"><span>About us</span><i class="touch-arrow-down"></i></a>
          ...
          <ul>		  <li><a href="/en/plus/list.php?tid=14"><span>Company news</span></a></li><li><a href="/en/plus/list.php?tid=15"><span>Information</span></a></li>
...
E-MAIL：thinkout@bjthinkout.com</p>
   ...
   <div class="gotop-wrapper">
    <a href="javascript:;" class="fixed-gotop gotop" style="display: none;"></a>
   </div>
   <!-- E go top --> 
